...
func (m *UserModel) GetForToken(scope, tokenPlaintext string) (*User, error) {
	// Calculate password hash which returns a byte array with length 32
	...
	// since pq drver does not support arrays, use [:] operator to make a slice containing the same values
